      ...
      <div className="w-full mb-20">
        <div className="w-full h-[30vh] md:h-[50vh]">
          {movieDetails.poster_path && (
            <img
              src={`${import.meta.env.VITE_APP_APIURLIMG}/${
        ...
        <div className="w-[90vw] md:w-[85vw] mx-auto flex">
          ...
          <div className="w-[75%] px-5 py-2 flex flex-col gap-2">
            ...
            <p className="text-white text-lg md:text-xl font-bold">
              Director:{" "}
              {credit.crew.find(({ job }) => job === "Director")?.name}
            </p>
            ...
            <p className="px-3 py-1 md:px-6 md:py-2 bg-[#DA7086] font-bold rounded-lg mt-8 text-[#12101D]">
        ...
        <div className="w-[90vw] md:w-[85vw] mx-auto mt-10">
          <h1 className="text-2xl md:text-3xl text-white py-1 border-b-2 border-white">
            Streaming
          </h1>
          {watchProviders ? (
        ...
        <h1 className="w-[90vw] md:w-[85vw] mx-auto mt-10 text-2xl md:text-3xl text-white py-1 border-b-2 border-white">
          Cast
        </h1>
